<template>
  <section class="testimonial-section testimonial-3">
    <div class="container">
      <div class="row text-center justify-content-center">
        <div class="col-sm-12 col-lg-10">
          <div>
            <p class="testimonial-text mb-3">
              "Checkly is incredible: It combines Pingdom, Ghost Inspector and
              Assertible all in the same app, and the insights are much more
              detailed."
            </p>
