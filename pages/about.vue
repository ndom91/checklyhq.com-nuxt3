<template>
  <div>
    <div class="main container pt-5">
            ...
            <div class="col-sm-12 col-lg-8">
              ...
              <div class="row">
                <div class="col-md-6 col-lg-4 align-items-center text-center">
                  <img
                    src="/about/images/tnolet.jpg"
                    alt="portrait Tim Nolet"
                    class="avatar mb-3"
                    width="128"
                    height="128"
                  />
                ...
                <div class="col-md-6 col-lg-4 align-items-center text-center">
                  <img
                    src="/about/images/teuteneuer.jpg"
                    alt="portrait Timo Euteneuer"
                    class="avatar mb-3"
                    width="128"
                    height="128"
                  />
        ...
        <div class="container">
          <div class="row text-left justify-content-center pt-5">
            <div class="col-sm-12 col-lg-8">
              ...
              <div class="">
                <img
                  src="/about/images/accel_400x400.jpg"
                  alt="accel logo"
                  class="avatar mb-3"
                  width="96"
                  height="96"
              ...
              <div class="row text-left justify-content-center">
                <div class="col-md-4">
                  <dl>
                    <dt>Andrei Brasoveanu</dt>
                    <dd>Accel</dd>
                    <dt>Guillermo Rauch</dt>
                    <dd>CEO @ Vercel</dd>
                    <dt>Robin Vasan</dt>
                    <dd>Founder @ Mango Capital</dd>
                  </dl>
                </div>
                <div class="col-md-4">
                  <dl>
                    <dt>Christian Henschel</dt>
                    <dd>CEO @ Adjust</dd>
                    <dt>Paul Müller</dt>
                    <dd>CTO @ Adjust</dd>
                    <dt>Philip Moehring</dt>
                    <dd>Tiny VC</dd>
                  </dl>
                </div>
                <div class="col-md-4">
                  <dl>
                    <dt>Ott Kaukver</dt>
                    <dd>ex-CTO Twilio</dd>
                    <dt>Mirko Novakovic</dt>
                    <dd>CEO @ Instana</dd>
                    <dt>Charles Ramsey</dt>
                    <dd>ex-CEO Saucelabs</dd>
                  </dl>
                </div>
              </div>
            </div>
      ...
      <section>
        <div class="container">
          <div class="row text-left justify-content-center pt-5 mb-5">
            <div class="col-sm-12 col-lg-8">
              <h2>Contact</h2>
              <p>
